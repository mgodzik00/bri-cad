...
struct bu_structparse view_parse[] = {
    {"%d", 1, "detect_regions", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "dr", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "detect_distance", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "dd", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "detect_normals", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "dn", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "detect_ids", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "di", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f", 3, "foreground", 0, color_hook, NULL, NULL, NULL},
    {"%f", 3, "fg", 0, color_hook, NULL, NULL, NULL},
    {"%f", 3, "background", 0, color_hook, NULL, NULL, NULL},
    {"%f", 3, "bg", 0, color_hook, NULL, NULL, NULL},
    {"%d", 1, "overlay", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "ov", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "blend", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "bl", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "region_color", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "rc", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%V", 1, "occlusion_objects", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%V", 1, "oo", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "occlusion_mode", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "om", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f", 1, "max_dist", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f", 1, "md", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "antialias", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "aa", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "both_sides", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "bs", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "draw_axes", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "da", 0, BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
