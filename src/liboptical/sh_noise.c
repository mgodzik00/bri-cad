...
struct bu_structparse noise_print_tab[] = {
    ...
    {"%f", 3, "delta",		SHDR_O(delta),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "size",		SHDR_O(size),		bu_mm_cvt, NULL, NULL, NULL },
    {"%g", 1, "angle",		SHDR_O(max_angle),	noise_deg_to_rad, NULL, NULL, NULL },
    {"%f", 3, "vscale",		SHDR_O(vscale),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "min",		SHDR_O(minval),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"",   0, (char *)0,	0,			BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL }
};


struct bu_structparse noise_parse_tab[] = {
    {"%p", 1, "noise_print_tab", bu_byteoffset(noise_print_tab[0]), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "lacunarity",	SHDR_O(lacunarity),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    ...
    {"%f", 3, "delta",		SHDR_O(delta),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f", 3, "d",		SHDR_O(delta),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "size",		SHDR_O(size),		bu_mm_cvt, NULL, NULL, NULL },
    {"%g", 1, "s",		SHDR_O(size),		bu_mm_cvt, NULL, NULL, NULL },
    {"%g", 1, "angle",		SHDR_O(max_angle),	noise_deg_to_rad, NULL, NULL, NULL },
    {"%g", 1, "ang",		SHDR_O(max_angle),	noise_deg_to_rad, NULL, NULL, NULL },
    {"%g", 1, "a",		SHDR_O(max_angle),	noise_deg_to_rad, NULL, NULL, NULL },
    {"%f", 3, "vscale",		SHDR_O(vscale),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f", 3, "vs",		SHDR_O(vscale),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f", 3, "v",		SHDR_O(vscale),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "min",		SHDR_O(minval),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"",   0, (char *)0,	0,			BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL }
};
