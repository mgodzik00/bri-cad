...
struct bu_structparse points_parse[] = {
    {"%s",	PT_NAME_LEN, "file", POINTS_O(pt_file),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d",	1, "size",		POINTS_O(pt_size),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d",	1, "w",			POINTS_O(pt_size),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
