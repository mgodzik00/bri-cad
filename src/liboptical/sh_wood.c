...
struct bu_structparse wood_parse[] = {
    {"%d",	1, "ident",		WOOD_O(ident),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d",	1, "id",		WOOD_O(ident),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d",	1, "overlay",		WOOD_O(overlay),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d",	1, "o",			WOOD_O(overlay),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d",	1, "ns",		WOOD_O(ns),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "jitter",		WOOD_O(jitter),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "j",			WOOD_O(jitter),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "lt_rgb",		WOOD_O(lt_rgb),	        BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "lt",		WOOD_O(lt_rgb),	        BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "dk_rgb",		WOOD_O(dk_rgb),	        BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "dk",		WOOD_O(dk_rgb),	        BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "spacing",		WOOD_O(spacing),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "s",			WOOD_O(spacing),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "scale",		WOOD_O(scale),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "sc",		WOOD_O(scale),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "phase",		WOOD_O(phase),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "p",			WOOD_O(phase),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "qd",		WOOD_O(qd),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "qp",		WOOD_O(qp),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "dither",		WOOD_O(dither),	        BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "di",		WOOD_O(dither),	        BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "depth",		WOOD_O(depth),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "de",		WOOD_O(depth),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "dd",		WOOD_O(dd),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	1, "dz",		WOOD_O(dz),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "rotation",		WOOD_O(rot),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "r",			WOOD_O(rot),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f",	3, "D",			WOOD_O(D),		wood_D_set, NULL, NULL, NULL },
    {"%f",	3, "V",			WOOD_O(V),		wood_V_set, NULL, NULL, NULL },
