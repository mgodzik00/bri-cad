...
struct bu_structparse fbm_parse[] = {
    {"%g", 1, "lacunarity",	FBM_O(lacunarity),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "H", 		FBM_O(h_val),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "octaves", 	FBM_O(octaves),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "gain",		FBM_O(gain),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "distortion",	FBM_O(distortion),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "l",		FBM_O(lacunarity),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%d", 1, "o", 		FBM_O(octaves),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "g",		FBM_O(gain),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%g", 1, "d",		FBM_O(distortion),	BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    {"%f", 3, "scale",		FBM_O(scale),		BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
