...
const struct bu_structparse rt_revolve_parse[] = {
    { "%f", 3, "V",   bu_offsetofarray(struct rt_revolve_internal, v3d, fastf_t, X),  BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    { "%f", 3, "axis", bu_offsetofarray(struct rt_revolve_internal, axis3d, fastf_t, X),  BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    { "%f", 3, "R",   bu_offsetofarray(struct rt_revolve_internal, r, fastf_t, X), BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    { "%f", 1, "ang", bu_offsetof(struct rt_revolve_internal, ang),    BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
    { "%V", 1, "sk_name", bu_offsetof(struct rt_revolve_internal, sketch_name),  BU_STRUCTPARSE_FUNC_NULL, NULL, NULL, NULL },
