...
rt_bot_repair(struct rt_bot_internal **obot, struct rt_bot_internal *bot, struct rt_bot_repair_info *settings)
{
    ...
    *obot = NULL;
	...
	bot_mesh.vertProperties.push_back(bot->vertices[3*j]);
	...
	*obot = nbot;
	...
	gmm.vertProperties.push_back(gm_v[0]);
	gmm.vertProperties.push_back(gm_v[1]);
	gmm.vertProperties.push_back(gm_v[2]);
    }
	...
	gmm.triVerts.push_back(tri_verts[0]);
	gmm.triVerts.push_back(tri_verts[1]);
	gmm.triVerts.push_back(tri_verts[2]);
    }
